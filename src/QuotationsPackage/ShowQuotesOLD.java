 ...
 * @author c_harford
 */
public class ShowQuotesOLD extends JPanel {
    public ShowQuotesOLD() {
        initComponents();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                ShowQuotesOLD.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                ShowQuotesOLD.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                ShowQuotesOLD.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                ShowQuotesOLD.this.deleteButtonActionPerformed(evt);
            }
        }
    }
